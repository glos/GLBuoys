...
function callAboutGLBuoys(){		
			...
			$('#bannerNews').append('<p>Welcome to the new Great Lakes Buoys website! This site provides access to real-time observations from buoys across the Great Lakes.  Please look around, check conditions at your favorite buoy, bookmark it, and give us feedback!  We’d love to hear how you use this new site, any suggestions for improvements, or just to say hi! Click <a href="https://goo.gl/forms/9a3v1XZCUA56loOp1" target="_blank">here</a> to provide us your feedback.</p>');
			...
			$('footer p').append('<p>Please send comments about the Great Lakes Buoys website to <a id="comments" href="https://goo.gl/forms/9a3v1XZCUA56loOp1" target="_blank">dmac@glos.us</a></p>')
...
function loadbuoyinfo_home(callback) {
    var data_file = "http://34.211.180.62//BuoyALP/buoymeta/all";
