    ...
    var options2 = {
        ...
        tooltip: {
            formatter: function () {
                ...
                try {
									return 'Date: ' +  date + '<br> Depth: ' + DepthFt + ' ft<br> Water Temp: ' + this.point.value.toFixed(1) + ' °F';
								} catch (err) {
									return 'Date: ' +  date + '<br> Depth: ' + DepthFt + ' ft<br> Water Temp: NA';
								}
            }
        },
        //plotOptions: {
